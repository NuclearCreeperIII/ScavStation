/datum/map/apartment
	name = "Apartment"
	full_name = "Salia Prime Premium Apartment Block 32"
	path = "apartment"
	ground_noun = "floor"

	station_name = "Salia Prime Premium Apartment Block 32"
	station_short = "Mollusc"

	dock_name     = "Salia Prime Transport Hub"
	...
	lobby_screens = list('maps/apartment/ministation_lobby.png')
...
/datum/map/apartment/get_map_info()
